import html from '@/assets/icons/0 HTML5.png';
import css from '@/assets/icons/0 CSS3.png';
import js from '@/assets/icons/0 JavaScript.png';
import ts from '@/assets/icons/0 TypeScript.png';
import git from '@/assets/icons/1 Git.png';
...
import canva from '@/assets/icons/3 Canva.png';
import figma from '@/assets/icons/3 Figma.png';
import filmora from '@/assets/icons/3 Filmora.png';
import vercel from '@/assets/icons/3 Vercel.png';
...
export const imagesArray = [
    ...
    { src: filmora, title: 'Wondershare Filmora' },
    { src: vercel, title: 'Vercel' }]